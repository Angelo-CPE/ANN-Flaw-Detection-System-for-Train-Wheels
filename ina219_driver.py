...
class INA219:
    ...
    def set_calibration_32V_2A(self):
        ...
        # MaxLSB = MaxPossible_I/4096
        # MaxLSB = 0.00078125                   (781uA per bit)
        
        # 4. Choose an LSB between the min and max values
        # (Preferrably a roundish number close to MinLSB)
        # CurrentLSB = 0.0001                   (100uA per bit)
        self.current_lsb = .1 # Current LSB = 100uA per bit
        ...
        self.power_lsb = .002 # Power LSB = 2mW per bit
        
        # 7. Compute the maximum current and shunt voltage values before overflow
        # Max_Current = Current_LSB * 32767
        # Max_Current = 3.2767A before overflow
        # MaxPossible_I = VBUS_MAX / RSHUNT
        # MaxPossible_I = 3.2A
        ...
        # Max_Current_Before_Overflow = Max_Current
        # End If
        # MaxShuntVoltage = Max_Current_Before_Overflow * RSHUNT
        # MaxShuntVoltage = 0.32V
    ...
    def getShuntVoltage_mV(self):
        self.write(_REG_CALIBRATION, self.cal_value)
        value = self.read(_REG_SHUNT_VOLTAGE)
        if value > 32767:
            value -= 65535
        return value * 0.01
    ...
    def getBusVoltage_V(self):
        self.write(_REG_CALIBRATION, self.cal_value)
        value = self.read(_REG_BUS_VOLTAGE)
...
if __name__ == "__main__":
    ina219 = INA219()
    print("Measuring voltage, current, and power...")
    while True:
